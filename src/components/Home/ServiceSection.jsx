...
const services = [
  {
    ...
    desc: "Our obsession with perfection meets ultimate protection. An invisible, self-healing shield to keep your car’s finish safe from chips and scratches.",
    image: "/obsessions-ppf.avif",
    path: "/services/ppf",
  },
  {
    title: "PAINT CORRECTION",
    desc: "We eliminate swirls and imperfections with multi-stage machine polishing to restore that deep, diamond-level clarity to your paintwork.",
    image: "/obsessions-correction.avif",
    path: "/services/paint-correction",
  },
  {
    title: "CERAMIC COATING",
    desc: "Experience extreme hydrophobicity and a high-gloss finish that protects your vehicle against the elements while making maintenance effortless.",
    image: "/obsessions-ceramic.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto ">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-70   "
                    onError={(e) => {
